function [regressor,name]=RetroicorRegressor_Heartbeat(subject,phase)
%[regressor]=RetroicorRegressor_Heartbeat(subject,phase,highpass)
%   
%   Assigns to each pulse a phase values based on peak to peak distances
...
%
%
%   Selim Onat, 07-Apr-2013 21:03:09
%
